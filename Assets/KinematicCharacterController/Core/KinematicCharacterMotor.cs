...
#pragma warning restore 0414 
        ...
        private void Awake()
        {
            ...
            void Start()
            {
                // Get the layer index for "ignoreDetection"
                int ignoreLayer = LayerMask.NameToLayer("IgnoreDetection");

                // Get the player's layer
                int playerLayer = gameObject.layer;

                // Make the player's layer ignore collisions with "ignoreDetection"
                Physics.IgnoreLayerCollision(playerLayer, ignoreLayer, true);
            }
