...
//public class PoolOuterTiles : ItemPickandPlace, InteractableObjects
//{
...
//                if (currentTool == null)
//                {
//                    UIController.instance.DisplayHoverObjectName("Select Paint Brush To Paint Outer Tiles!", true, HoverInstructionType.Tools);
//                }
//                else if (currentTool.GetComponent<PaintBrushTool>() != null)
//                {
//                    if (currentTool.GetComponent<PaintBrushTool>().subCatIdOfPaint == 1)
//                    {
//                        UIController.instance.DisplayHoverObjectName("Tap To Paint Outer Tiles!", true, HoverInstructionType.General);
//                        UIController.instance.OnChangeInteraction(0, true);
//                    }
//                    else
//                    {
//                        UIController.instance.DisplayHoverObjectName("Buy Outer Tile Paint To Paint Outer Tiles!", true, HoverInstructionType.GameStore);
//                    }
//                }
//                else
//                {
...
//        {
//            PoolManager.instance.inactiveCountofOuterTiles++;
//        }
...
//        PoolManager.instance.SetOuterTileItemId(indexInRoomList, paintBrushTool.ItemId);  // indexInRoomList: the index number in the outerTilesParent gameobject
