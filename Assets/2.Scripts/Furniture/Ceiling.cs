...
//public class Ceiling : ItemPickandPlace, InteractableObjects
//{
...
//                    {
//                        if (paintBrushTool.subCatIdOfPaint == 2)// && RoomManager.instance.rooms[RoomManager.instance.currentRoomNumber].AreAllTrashTasksComplete())
//                        {
...
//                if (currentTool == null)
//                {
//                    UIController.instance.DisplayHoverObjectName("Select Paint Brush To Paint Ceilings!", true, HoverInstructionType.Tools);
//                }
//                else if (currentTool.GetComponent<PaintBrushTool>() !=null )
//                {
//                    if (currentTool.GetComponent<PaintBrushTool>().subCatIdOfPaint == 2)
//                    {
//                        UIController.instance.DisplayHoverObjectName("Tap To Paint Ceilings!", true, HoverInstructionType.General);
//                        UIController.instance.OnChangeInteraction(0, true);
//                    }
//                    else
//                    {
//                        UIController.instance.DisplayHoverObjectName("Buy Ceiling Paint To Paint Ceilings!", true, HoverInstructionType.GameStore);
//                    }
//                }
//                else
//                {
...
//        {
//            RoomManager.instance.rooms[RoomManager.instance.currentRoomNumber].inactiveCountofCeiling++;
//        }
...
//        RoomManager.instance.SetCeilingItemId(placedRoomIndex, indexInRoomList, paintBrushTool.ItemId);
//        HapticFeedback.LightFeedback();
//        RoomManager.instance.rooms[RoomManager.instance.currentRoomNumber].OnCeilPaint(RoomManager.instance.currentRoomNumber);
//    }
