...
//public class Walls : ItemPickandPlace, InteractableObjects
//{
...
//                    {
//                        if (paintBrushTool.subCatIdOfPaint == 0)// && RoomManager.instance.rooms[RoomManager.instance.currentRoomNumber].AreAllTrashTasksComplete())
//                        {
...
//                if (currentTool == null)
//                {
//                    UIController.instance.DisplayHoverObjectName("Select Paint Brush To Paint Walls!", true, HoverInstructionType.Tools);
//                }
//                else if (currentTool.GetComponent<PaintBrushTool>() != null)
//                {
//                    if(currentTool.GetComponent<PaintBrushTool>().subCatIdOfPaint == 0)
//                    {
//                        UIController.instance.DisplayHoverObjectName("Tap To Paint Walls!", true, HoverInstructionType.General);
//                        UIController.instance.OnChangeInteraction(0, true);
//                    }
//                    else
//                    {
//                        UIController.instance.DisplayHoverObjectName("Buy Wall Paint To Paint Walls!", true, HoverInstructionType.GameStore);
//                    }
//                }
//                else
//                {
...
//        {
//            RoomManager.instance.rooms[RoomManager.instance.currentRoomNumber].inactiveCountofWall++;
//        }
...
//        RoomManager.instance.SetWallItemId(placedRoomIndex, indexInRoomList, paintBrushTool.ItemId);
//        HapticFeedback.LightFeedback();
//        RoomManager.instance.rooms[RoomManager.instance.currentRoomNumber].OnWallPaint(RoomManager.instance.currentRoomNumber);
//    }
