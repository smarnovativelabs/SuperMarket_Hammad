...
//public class PoolInnerTiles : ItemPickandPlace, InteractableObjects
//{
...
//                    {
//                        if (paintBrushTool.subCatIdOfPaint == 0)// && paintBrushTool.mainId == CategoryName.Paint && RoomManager.instance.rooms[RoomManager.instance.currentRoomNumber].AreAllTrashTasksComplete())
//                        {
...
//                if (currentTool == null)
//                {
//                    UIController.instance.DisplayHoverObjectName("Select Paint Brush To Paint Inner Tiles!", true, HoverInstructionType.Tools);
//                }
//                else if (currentTool.GetComponent<PaintBrushTool>() != null)
//                {
//                    if (currentTool.GetComponent<PaintBrushTool>().subCatIdOfPaint == 0)
//                    {
//                        UIController.instance.DisplayHoverObjectName("Tap To Paint Inner Tiles!", true, HoverInstructionType.General);
//                        UIController.instance.OnChangeInteraction(0, true);
//                    }
//                    else
//                    {
//                        UIController.instance.DisplayHoverObjectName("Buy Inner Tile Paint To Paint Inner Tiles!", true, HoverInstructionType.GameStore);
//                    }
//                }
//                else
//                {
...
//        {
//            PoolManager.instance.inactiveCountofInnerTiles++;
//        }
//        PoolManager.instance.CheckPoolProgress();
...
//        PoolManager.instance.SetInnerTileItemId(indexInRoomList, paintBrushTool.ItemId);  // indexInRoomList: the index number in the innerTilesParent gameobject
